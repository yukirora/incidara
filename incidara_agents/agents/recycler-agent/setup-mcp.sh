#!/bin/bash
# incidara_agents/agents/recycler-agent/setup-mcp.sh
# Configure MCP servers for the recycler agent container.
...
print(f"MCP configured in /root/.claude.json (role={role}, agent={env('AGENT_NAME', 'recycler')})")
PYEOF
